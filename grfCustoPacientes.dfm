object grfCustoPaciente: TgrfCustoPaciente
  Left = 205
  Top = 282
  Width = 738
  Height = 375
  Caption = 'grfCustoPaciente'
  Color = clBtnFace
  ...
  object qrpRelatorio: TQuickRep
    ...
    object bndCabecalho: TQRBand
      ...
      object lblTitulo: TQRLabel
        ...
        AutoSize = True
        AutoStretch = False
        Caption = 'Evolu'#231#227'o do Custo M'#233'dio por Paciente '
        Color = clWhite
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clWindowText
        Font.Height = -16
  ...
  object dbGrafico: TTable
    OnCalcFields = dbGraficoCalcFields
    DatabaseName = 'BB'
