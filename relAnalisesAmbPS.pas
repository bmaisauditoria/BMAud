...
type
  TrelAnaliseAmbPS = class(TForm)
    ...
    QRExpr5: TQRExpr;
    QRExpr6: TQRExpr;
    qryRelatorioValorNA: TCurrencyField;
    QRLabel4: TQRLabel;
    QRLabel5: TQRLabel;
    QRLabel9: TQRLabel;
    QRDBText6: TQRDBText;
...
var
  relAnaliseAmbPS: TrelAnaliseAmbPS;

implementation

{$R *.dfm}

procedure TrelAnaliseAmbPS.qryRelatorioCalcFields(DataSet: TDataSet);
begin
