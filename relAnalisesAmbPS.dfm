object relAnaliseAmbPS: TrelAnaliseAmbPS
  Left = 191
  Top = 107
  Width = 1064
  Height = 381
  Caption = 'relAnaliseAmbPS'
  Color = clBtnFace
  ...
  object qrpRelatorio: TQuickRep
    ...
    object QRBand1: TQRBand
      ...
      object QRExpr8: TQRExpr
        ...
        Transparent = True
        WordWrap = True
        Expression = 'SUM(qryRelatorio.ValorNA)'
        Mask = 'R$###,###,##0.00'
        FontSize = 9
      end
    end
  ...
  object qryRelatorio: TQuery
    ...
    SQL.Strings = (
      ...
      '            BBHospitais.Nome,'
      '            BBHospitais.Regiao,'
      '            sum(BBAtendimentoHPS.ValorNaoAcordado) as ValorNA,'
    ...
    object qryRelatorioValorNA: TCurrencyField
      FieldName = 'ValorNA'
